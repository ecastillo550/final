...
namespace Splitpage.Data
{
    ...
    public abstract class SampleDataCommon : Splitpage.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public async void GetDataGenero()
        {
            ...
            foreach (var genero in listaGenero.ObtenerListaTodosGenerosResult)
            {
                ...
                foreach (var libro in genero.ListaLibros)
                {
        ...
        public async void GetDataAutor()
        {
            ...
            {
                var group = new SampleDataGroup(autor.AutorID.ToString(),
                ...
                foreach (var libro in autor.ListaLibros)
                {
                    group.Items.Add(new SampleDataItem(libro.LibroID.ToString(),
                    libro.Nombre,
                    autor.Nombre + " " + autor.ApPaterno,
